...
# Output basename:
strPathOut = '/media/sf_D_DRIVE/MotionLocaliser/Simulation2p0/FitResults/Sim'
...
if lgcCrteMdl:
    ...
    # experiment.
    strPathPng = '/media/sf_D_DRIVE/MotionLocaliser/Simulation2p0/Apertures/PNGs/' + aperture + '/' + aperture + '_'
