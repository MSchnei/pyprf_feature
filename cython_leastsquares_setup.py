...
# Compile the code:
setup(ext_modules=cythonize('pyprf_feature/analysis/find_prf_utils_cy_one.pyx'),
      include_dirs=[np.get_include()])
setup(ext_modules=cythonize('pyprf_feature/analysis/find_prf_utils_cy_two.pyx'),
      include_dirs=[np.get_include()])
